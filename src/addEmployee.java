...
public class addEmployee extends JFrame implements ActionListener{
    ...
    addEmployee(){
        ...
        // heading of frame
        JLabel lblheading = new JLabel("ADD EMPLOYEE DETAILS");
        lblheading.setBounds(400, 30, 360, 30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        // cbjob.getSelectedItem() method return a object therefore have to type cast in string
        String job = (String) cbjob.getSelectedItem();


        // now use database server
        try{
